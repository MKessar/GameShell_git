...
_mission_init() {
  ...
  then
    ...
    git branch flame origin/flame_added &> /dev/null
    git branch cheater origin/cheater_added &> /dev/null
    git branch beer origin/beer_added &> /dev/null
    git checkout beer &> /dev/null
    git branch -f main origin/moving_spell_into_Chapter_1 &> /dev/null
